...
import FormCadastroQuestao from '../../../components/FormCadastroQuestao';
...
const BancoQuestoes = () => {
  ...
  const handleFilter = async () => {
    try {
      ...
      const items = await api.get('/questoes', { 
        params,
      });
  ...
  useEffect(() => {
    document.title = 'Banco de Questões | Smart Owl';         
  }, []);
  ...
  return (
    <AdmDrawer title="Banco de Questões">
      <div className="master-dashboard">                
        <BackgroundCard>
          <BackgroundCardHeader title="Banco de Questões">
            ...
            <PrimaryButton variant="contained" size="large" title={"Nova Questão"}
              ...
              <div className="filter-form-basic">              
                <div className="input-block">
                  <TextField                                    
                    ...
                    select                
                  >
                    <MenuItem value="MAT" key="1">Matemática</MenuItem>
                    <MenuItem value="PORT" key="2">Português</MenuItem>
                    <MenuItem value="TODAS" key="3">Todas</MenuItem>
                  </TextField> 
                </div>
                <div className="input-block">
                  <TextField                                    
