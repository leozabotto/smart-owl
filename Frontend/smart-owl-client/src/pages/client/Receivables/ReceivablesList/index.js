...
const ReceivablesList = () => {
  ...
  const handleReport = async  () => {
    ...
    try {
      ...
      download(pdf.data, 'GestFacil - Contas a Receber.pdf');
  ...
  useEffect(() => {
    document.title = 'Contas a Receber | GestFacil';      
  ...
  return (
    <ClientDrawer title="Contas a Receber">
      <div className="master-dashboard">                
        <BackgroundCard>
          <BackgroundCardHeader title="Contas a Receber">
            { processingReport ?
            ...
            <PrimaryButton variant="contained" size="large" title={"Nova Conta"}
              onClick={() => handleCreateModalOpen()}  
            >
              <AddIcon />
            </PrimaryButton>
           
            <PrimaryButton variant="contained" size="large" onClick={handleReport} title={"Gerar Relatório"}>
                <PrintIcon />
            </PrimaryButton>
            </>
          }
      ...
      >        
        <p>
          <strong>ATENÇÃO: </strong> está ação é <b>permanente</b> e afetará o valor total de contas a receber.
        </p>
      </Modal>
    </ClientDrawer>
  );
