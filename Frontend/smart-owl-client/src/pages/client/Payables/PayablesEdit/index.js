...
const PayableAccEdit = () => {
  ...
  const handleRedirect = () => {
    ...
    history.push("/cli/payable_accounts");
  }

  useEffect(() => {
    document.title = 'Nova Conta a Pagar | GestFacil';

    async function getAccount() {
      const account = await api.get(`/payable/${id}`);
      console.log(account);
    }
    getAccount();
    ...
    <ClientDrawer title="GestFacil">
      <BackgroundCard>
        <HeaderTitle
          ...
          showBackButton
          previousPage="/cli/payable_accounts"
        />

        {
          ...
          <div className="file-form-container">
            <form 
              ...
              <HeaderSubtitle
                title="Informações da Conta a Pagar"
              />
