...
const SuppliersCreate = () => {
  ...
  useEffect(() => {
    document.title = 'Cadastro de Fornecedor | GestFacil';
  }, []);
  ...
  const handleSubmit = async (e, form) => {
    try {
      ...
      setSnack({ 
        message: 'Falha ao cadastrar o fornecedor, contate o suporte. Erro: ' + err.message, 
        type: 'error', 
        open: true
      });
      return false;
  ...
  return (
    <ClientDrawer title="Fornecedor / Cadastro">
      <BackgroundCard>
        <HeaderTitle
