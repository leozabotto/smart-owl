    ...
    <div>
      ...
      >
        <ListItem button 
          ...
          component={Link} 
          to="/adm/dashboard" 
          selected={location.pathname === "/adm/dashboard"}
        >
          <ListItemIcon>
            <HomeIcon />
          </ListItemIcon>
              ...
              >
                ...
                <Grid item>
                  ...
                  <Menu
                    ...
                    onClose={handleClose}
                  >
                    <MenuItem onClick={() => history.push('/adm/profile')}>Meu Perfil</MenuItem>
            ...
            <div className="container-info">
              ...
              <div className="user">
                ...
                <div className="actions">
                  <Link to="/adm/profile/"><PersonIcon />Meu Perfil</Link>
                  <p>/</p>
